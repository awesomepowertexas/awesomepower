    ...
    <>
      ...
      <div className="prose prose-blue mx-auto w-full max-w-2xl px-4 pt-20 pb-8 md:pt-48 md:pb-20">
        ...
        <p>
          ...
          your relationship with https://awesomepowertexas.com website (the
          "Service") operated by Awesome Power ("us", "we", or "our").
        </p>
        ...
        <p>
          ...
          that are not owned or controlled by Awesome Power.
        </p>

        <p>
          Awesome Power has no control over, and assumes no responsibility for,
          the content, privacy policies, or practices of any third party web
          sites or services. You further acknowledge and agree that Awesome
          Power shall not be responsible or liable, directly or indirectly, for
        ...
        <p>
          In no event shall Awesome Power, nor its directors, employees,
        ...
        <p>
          ...
          expected price shown. We do not guarantee the accuracy of information
          on this website. By using this website, you agree to indemnify and
          hold harmless Awesome Power, its owners, and its employees from any
          damages caused as a result of the information and services you obtain
          from this website.
        </p>
